const en = {
  translation: {
    ...
    saveButton: "Save",
    footerText:
      "Dino's Pedidos is an open-source delivery management platform for the future. We prioritize innovation, flexibility, and affordability, and offer a scalable, customizable solution that streamlines your delivery processes.",
    footerLinkHome: "Home",
    footerLinkPP: "Privacy Policy",
    footerLinkTC: "Terms & Conditions",
    footerEndText: "Dino's Pedidos – © 2022 All Rights Reserved",
    followUs: "Follow Us",
    ...
    createAccount: "Create your Dino's Pedidos Account",
    ...
    orderSubText1:
      "Experience the convenience of having all your favorite restaurant meals and cuisines in one place, delivered straight to your door—fast and fresh. Download the Dino's Pedidos App today, and turn every craving into a delicious reality.",
    orderSubText2:
      "Explore a wide range of options, from local favorites and comfort food to gourmet dishes, healthy eats, and more.",
    orderSubText3:
      "Download the Dino's Pedidos App today, and turn every craving into a delicious reality.",
    ...
    vendorDescription:
      "Expand your reach, attract more customers, and build stronger connections in every neighborhood. Join Dino's Pedidos as a vendor today!",
    ...
    welcomeText: "Welcome to Dino's Pedidos",
    emailConfirmationDescription:
      "We are thrilled to have you join us as we aim to make delivery better for everyone. As a delivery/pickup partner, you get to work according to your schedule anywhere, anytime. Need Help? send us an email at gerencia@dinospedidos.com",
    getStarted: "Get Started",
    thankyouPageHeading: "Your email has been sent successfully!",
    thankyouPageDescription:
      "A member of our team will reach out to you shortly to help you get set-up and answer any questions you might have. Need Help? send us an email at gerencia@dinospedidos.com",
