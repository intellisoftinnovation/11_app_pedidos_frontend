export const fr = {
  ...
  errorFetchingRider:
    "Une erreur s'est produite lors de la récupération des informations du livreur",
  ...
  withdrawlRequestSent:
    "Votre demande de retrait d'argent a été envoyée. Consultez votre e-mail pour plus de détails.",
  ...
  locationAccessText:
    'Des autorisations de localisation sont nécessaires pour utiliser cette application. Veuillez ouvrir les paramètres pour autoriser l’accès à la localisation.',
  allowLocation: 'Autoriser la localisation',
  enategaLocationText:
    'Enatega utilise votre emplacement pour des fonctionnalités telles que la recherche de commandes à proximité et le suivi des commandes des clients !',
  ...
  withdrawAmountError:
    'Le montant du retrait doit être inférieur ou égal au montant du portefeuille !',
